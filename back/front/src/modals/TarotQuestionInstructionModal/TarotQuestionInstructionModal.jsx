...
const TarotQuestionInstructionModal = ({ ...props }) => {
  ...
  const manualForKorean = props => {
    if (props?.questionKind === 1) {
      ...
      \n*
      ※ 질문자는 당신입니다. 질문자는 질문의 대상(질문에서 궁금한 사람 혹은 물건) 혹은 그 관련 인물/사물(질문의 대상에게 있어 관련이 있거나 상대가 되는 사람 혹은 물건)도 될 수 있고 이들과는 별개의 존재로 있을 수 있습니다.\n*
      -> 상세 입력 모드 질문 입력란 예시\n
      1) 질문 주제 : 나의 적성\n
      2) 질문의 대상 : 나\n
      3) 관련 인물/사물 : (생략)\n
      4) 관계 : (생략)(질문의 대상) / (생략)(관련 인물/사물)\n
      5) 배경 : 나는 진로를 정해야 한다.\n
      6) 질문 : 나의 적성은 뭔가? 나에게 추천되는 직업은?\n
      `;
    } else if (props?.questionKind === 2) {
      return `\n
      1. 질문에서 묻고자 하는 사람 혹은 물건입니다. 자기 자신 또는 누구든 상관 없습니다. 만일, 관련 인물/사물도 기입하려면 질문의 대상은 그 상대와 최소한의 일면식이 있는 관계여야 합니다. 모르는 사람이 나에게 어떤 마음인지 물어도 답변은 의미가 없습니다. 질문의 대상에 기입하면 마이페이지에서 대상별로 카테고리화 한 타로카드 상담 통계 서비스를 이용하실 수 있습니다.\n*
      ...
      2) 질문의 대상 : 그 점원\n
      3) 관련 인물/사물 : 나\n
      4) 관계 : 음식점 점원(질문의 대상) / 손님(관련 인물/사물)\n
      ...
      return `\n
      1. 질문에서 묻고자 하는 사람 혹은 물건의 대상이 되는 혹은 관련이 있는 존재입니다. 자기 자신 또는 누구든 상관 없습니다. 대신, 관련 인물/사물는 질문의 대상과 최소한의 일면식이 있는 혹은 관련 있는 관계여야 합니다. 어떤 이가 모르는 사람에게 어떤 마음인지 물어도 답변은 의미가 없습니다.\n*
      ...
      2) 질문의 대상 : 그\n
      3) 관련 인물/사물 : 그녀\n
      4) 관계 : 친구(질문의 대상) / 친구(관련 인물/사물)\n
      5) 배경 : (생략)\n
      6) 질문 : 그녀에게 한 그의 말은 진실성이 얼마나 되나? 거짓말인가?\n
      `;
    } else if (props?.questionKind === 4) {
      return `\n
      1. 질문의 대상과 관련 인물/사물의 관계입니다. 질문의 대상란에는 관련 인물/사물에게 있어서 어떤 관계나 어떤 존재인지 기입하면 됩니다. 관련 인물/사물 또한 질문의 대상에게 있어서 어떤 관계나 어떤 존재인지 기입하면 됩니다.\n*
      ...
      2) 질문의 대상 : 그\n
      3) 관련 인물/사물 : 나\n
      4) 관계 : 같은 회사 직원(질문의 대상) / 같은 회사 직원(관련 인물/사물)\n
      5) 배경 : 그는 오늘 유난히 나에게 관심을 보인 거 같다.\n
      6) 질문 : 그는 나에 대한 마음이 뭘까? 나에게 이성적 관심이 있는 건가?\n
      `;
    } else if (props?.questionKind === 5) {
      return `\n
      1. 질문의 배경이 되는 상황을 설명해주세요. 질문과 관련된 당사자(질문의 대상), 관계자(관련 인물/사물), 또는 주변 상황(제 3자 혹은 주변) 등을 자유롭게 기술하시면 됩니다.\n*
      ...
      2) 질문의 대상 : 그\n
      3) 관련 인물/사물 : 그녀\n
      4) 관계 : 소개팅한 남자(질문의 대상) / 소개팅한 여자(관련 인물/사물)\n
  ...
  const manualForJapanese = props => {
    if (props?.questionKind === 1) {
      ...
      \n*
      ※ 質問者はあなたです。質問者は質問の対象（質問で気になる人やもの）または関連人物/物（質問の対象に関連があるまたは相対となる人やもの）になることもでき、これらとは別の存在であることもできます。\n*
      -> 詳細入力モード質問入力例\n
      1) テーマ：私の適性\n
      2) 質問の対象：私\n
      3) 関連人物/物：（省略）\n
      4) 関係：（省略）(質問の対象) / （省略）(関連人物/物)\n
      5) 質問内容の背景：私は進路を決めなければならない。\n
      6) 質問：私の適性は何か？私に推奨される職業は？\n
      `;
    } else if (props?.questionKind === 2) {
      return `\n
      1. 質問で聞きたい人やものです。自分自身または誰でも構いません。関連人物/物も記入する場合は、質問の対象はその相対と最低限の面識がある関係でなければなりません。知らない人が私にどんな気持ちかを聞いても回答は意味がありません。質問の対象を記入すると、マイページで対象者別に分類された占いカード相談の統計サービスをご利用いただけます。\n*
      ...
      2) 質問の対象：その店員\n
      3) 関連人物/物：私\n
      4) 関係：飲食店店員(質問の対象) / お客様(関連人物/物)\n
      5) 質問内容の背景：少し集中して時間を忘れて仕事をしていたら、飲食店の店員が来て水を注いでくれた。\n
      6) 質問：その飲食店の店員は追加注文を聞きたくて水を補充したのか？\n
      `;
    } else if (props?.questionKind === 3) {
      return `\n
      1. 質問で聞きたい人やものの対象となるまたは関連がある存在です。自分自身または誰でも構いません。ただし、関連人物/物は質問の対象と最低限の面識があるまたは関連がある関係でなければなりません。ある人が知らない人にどんな気持ちかを聞いても回答は意味がありません。\n*
      ...
      2) 質問の対象：彼\n
      3) 関連人物/物：彼女\n
      4) 関係：友達(質問の対象) / 友達(関連人物/物)\n
      5) 質問内容の背景：（省略）\n
      6) 質問：彼女に言った彼の言葉はどれだけ真実性があるのか？嘘なのか？\n
      `;
    } else if (props?.questionKind === 4) {
      return `\n
      1. 質問の対象と関連人物/物の関係です。質問の対象欄には関連人物/物にとってどのような関係やどのような存在なのかを記入してください。関連人物/物も質問の対象にとってどのような関係やどのような存在なのかを記入してください。\n*
      ...
      2) 質問の対象：彼\n
      3) 関連人物/物：私\n
      4) 関係：同じ会社の社員(質問の対象) / 同じ会社の社員(関連人物/物)\n
      5) 質問内容の背景：彼は今日特に私に関心を示しているようだ。\n
      6) 質問：彼の私に対する気持ちは何だろう？私に恋愛的関心があるのか？\n
      `;
    } else if (props?.questionKind === 5) {
      return `\n
      1. 質問の背景となる状況を説明してください。質問に関連する当事者（質問の対象）、関係者（関連人物/物）、または周辺状況（第三者または周辺）などを自由に記述してください。\n*
      ...
      2) 質問の対象：彼\n
      3) 関連人物/物：彼女\n
      4) 関係：お見合いした男性(質問の対象) / お見合いした女性(関連人物/物)\n
      ...
      \n*
      ※質問者はあなたです。質問者は質問の対象(質問で知りたい人物や物)またはその関連人物/物(質問の対象にとって関係のある人物や物)である場合もあります。また、これらとは別の存在でいることもできます。\n*
      -> 詳細入力モードの質問入力欄例\n
      1) 質問テーマ : AとBの中で彼の本心\n
      2) 質問の対象 : 彼\n
      3) 関連人物/物 : (省略)\n
      ...
      \n*
      ※ 質問者はあなたです。質問者は質問の対象(質問で知りたい人やもの)またはその関連人物/物(質問の対象に関連があるか相手となる人やもの)にもなれますし、これらとは別の存在としていることもできます。\n*
      -> 詳細入力モード質問入力例\n
      1) 質問テーマ：私の未来\n
      2) 質問の対象：私\n
      3) 関連人物/物：(省略)\n
