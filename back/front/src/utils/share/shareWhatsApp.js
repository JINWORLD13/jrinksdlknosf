...
export async function shareWhatsApp({ text, url, t }) {
  try {
    ...
    const androidStore = 'market://details?id=com.whatsapp';
    const androidStoreWeb =
      'https://play.google.com/store/apps/details?id=com.whatsapp';
    const iosStore = 'https://apps.apple.com/app/id310633997'; // WhatsApp iOS App ID
    ...
    if (typeof window !== 'undefined') {
      ...
      setTimeout(() => {
        try {
          const storeWebUrl = androidStoreWeb;
