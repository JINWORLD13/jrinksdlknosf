    ...
    <>
      ...
      <p>
        <strong>
          {language === 'en'
            ...
            : null}
          {language === 'ko'
            ? `${'관련 인물/사물(생략 가능) : '.slice(0, -10).concat(' : ')}`
            : null}
          {language === 'ja'
            ? `${'関連人物/物(省略可) ： '.slice(0, -8).concat(' : ')}`
            : null}
        </strong>
        {language === 'en'
      ...
      <p>
        ...
        {language === 'ja'
          ? `質問の対象: ${
            ...
            }\n ↔ \n関連人物/物: ${questionInfo?.relationship_object || '省略'}`
          : null}
      </p>
      <p>
        <strong>
      ...
      <p>
        ...
        {spreadInfo?.spreadListNumber === 304 && language === 'ja'
          ? `選択肢1: ${questionInfo?.firstOption || '省略'}\n / \n選択肢2: ${
              questionInfo?.secondOption || '省略'
            }\n / \n選択肢3: ${questionInfo?.thirdOption || '省략'}`
          : null}
      </p>
      <p
        style={{
      ...
      <div style={{ height: '0.8rem', margin: '0', display: 'block' }}></div>
    </>
  );
};
